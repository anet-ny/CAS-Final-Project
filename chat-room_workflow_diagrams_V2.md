...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#D9E1F2','primaryTextColor':'#000','primaryBorderColor':'#366092','lineColor':'#366092','secondaryColor':'#B4C7E7','tertiaryColor':'#8FAADC'}}}%%
gantt
...
graph TB
    ...
    style A fill:#366092,stroke:#000,color:#fff
    style J fill:#ff6b6b,stroke:#000,color:#000
    style O fill:#ff6b6b,stroke:#000,color:#000
    style R fill:#ff6b6b,stroke:#000,color:#000
    style U fill:#ff6b6b,stroke:#000,color:#000
    style X fill:#4ecdc4,stroke:#000,color:#000
    style E fill:#4ecdc4,stroke:#000,color:#000
    style K fill:#4ecdc4,stroke:#000,color:#000
```
...
graph LR
    ...
    style PM fill:#366092,stroke:#000,color:#fff
    style WP1 fill:#D9E1F2,stroke:#000,color:#000
    style WP2 fill:#D9E1F2,stroke:#000,color:#000
    style WP3 fill:#D9E1F2,stroke:#000,color:#000
    style WP4 fill:#D9E1F2,stroke:#000,color:#000
    style WP5 fill:#D9E1F2,stroke:#000,color:#000
    style WP6 fill:#D9E1F2,stroke:#000,color:#000
    style WP7 fill:#4ecdc4,stroke:#000,color:#000
```
...
graph TD
    ...
    style START fill:#366092,stroke:#000,color:#fff
    style CP4 fill:#ff6b6b,stroke:#000,color:#000
    style CP6 fill:#ff6b6b,stroke:#000,color:#000
    style CP7 fill:#ff6b6b,stroke:#000,color:#000
    style CP8 fill:#ff6b6b,stroke:#000,color:#000
    style END fill:#4ecdc4,stroke:#000,color:#000
    style PP5 fill:#4ecdc4,stroke:#000,color:#000
```
